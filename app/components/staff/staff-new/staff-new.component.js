System.register(['angular2/core', 'angular2/router', '../staff.service', '../../badge/badge.service'], function(exports_1, context_1) {
    ...
    return {
        ...
        execute: function() {
            StaffNewComponent = (function () {
                function StaffNewComponent(_staffService, _badgeService, _router, _routeParams) {
            ...
            exports_1("StaffNewComponent", StaffNewComponent);
        }
    }
});
