System.register(['angular2/core', 'angular2/router', './bs-edit/bs-edit.component', './bs.service', '../badge/badge.service', '../tier/tier.service', '../pipe/filter-array-pipe', '../pipe/yes-no-pipe'], function(exports_1, context_1) {
    "use strict";
    ...
    var core_1, router_1, bs_edit_component_1, bs_service_1, badge_service_1, tier_service_1, filter_array_pipe_1, yes_no_pipe_1;
    var BSComponent;
    return {
        setters:[
            function (core_1_1) {
        ...
        execute: function() {
            ...
            exports_1("BSComponent", BSComponent);
        }
    }
});
